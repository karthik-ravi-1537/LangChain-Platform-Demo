...
def test_imports():
    ...
    try:
        # Test basic Python imports - imports are only used for testing availability
        # noqa: F401 suppresses "imported but unused" warnings for test imports
        ...
        # Test project imports - these imports verify module structure is correct
        from config.settings import settings  # noqa: F401

        print("✅ Settings configuration imported successfully")

        from src.chains.basic_chain import BasicChain  # noqa: F401

        print("✅ Basic chain imported successfully")

        from src.tools.calculator import calculator_tool  # noqa: F401
